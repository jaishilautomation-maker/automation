...
// Columns:
//  Date | Name of Product | Op. Bal | Qty.Rec | BY TRANSFER |
 ...
 return (
  <>
   <div className="card">
    ...
    {/* Row 3: Qty. Issued | To Transfer | Cl. Bal computed */}
    <div className="row3">
     <div>
        ...
        <table className="dash" style={{ minWidth: 820 }}>
         <thead>
          <tr>
           ...
           <th style={{ textAlign: "right" }}>Qty.Rec</th>
           <th style={{ textAlign: "right" }}>By Transfer</th>
           <th style={{ textAlign: "right" }}>Qty. Issued</th>
           <th style={{ textAlign: "right" }}>To Transfer</th>
 ...
 return (
  <>
   <div className="card">
    ...
    {/* Row 2: O/BAL | PROD | Repacking BY TR */}
    <div className="row3">
     <div>
      <label>O/BAL in BAGS</label>
      <input type="number" step="1" placeholder="0"
       value={entry.op_bal}
       onChange={e => setField("op_bal", e.target.value)} />
     </div>
     ...
     <div>
      <label>Repacking material / BY TR</label>
      <input type="number" min="0" step="1" placeholder="0"
    ...
    {/* Row 3: Less packing Stock | Transfer TO TR | Dispatch */}
    <div className="row3">
     <div>
      <label>Less packing Stock</label>
      <input type="number" min="0" step="1" placeholder="0"
       value={entry.less_packing_stock}
       onChange={e => setField("less_packing_stock", e.target.value)} />
     </div>
     <div>
      <label>Transfer material / TO TR</label>
      <input type="number" min="0" step="1" placeholder="0"
        ...
        <table className="dash" style={{ minWidth: 950 }}>
         <thead>
          <tr>
           ...
           <th style={{ textAlign: "right" }}>O/BAL Bags</th>
           <th style={{ textAlign: "right" }}>PROD</th>
           <th style={{ textAlign: "right" }}>Repkg/BY TR</th>
           <th style={{ textAlign: "right" }}>Less Pkg</th>
           <th style={{ textAlign: "right" }}>Transfer/TO TR</th>
           <th style={{ textAlign: "right" }}>Dispatch</th>
     ...
     <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13 }}>
      <thead>
       <tr style={{ background: "var(--clay-soft)" }}>
        ...
        <th style={{ padding: "8px 6px", textAlign: "left", fontSize: 11 }}>Shift</th>
        <th style={{ padding: "8px 6px", textAlign: "left", fontSize: 11 }}>Party</th>
        <th style={{ padding: "8px 6px", textAlign: "left", fontSize: 11 }}>Batch No</th>
        <th style={{ padding: "8px 6px", textAlign: "right", fontSize: 11 }}>Qty MFG Bags</th>
        <th style={{ padding: "8px 6px", textAlign: "right", fontSize: 11 }}>KG (= Bags x 25)</th>
        <th style={{ padding: "8px 6px", textAlign: "right", fontSize: 11 }}>Total MT</th>
     ...
     <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13 }}>
      <thead>
       <tr style={{ background: "#e8f4e8" }}>
        <th style={{ padding: "8px 6px", textAlign: "left", fontSize: 11 }}>Dispatch Date</th>
        <th style={{ padding: "8px 6px", textAlign: "left", fontSize: 11 }}>Location</th>
        <th style={{ padding: "8px 6px", textAlign: "left", fontSize: 11 }}>Batch No</th>
        <th style={{ padding: "8px 6px", textAlign: "right", fontSize: 11 }}>Dispatch Bags</th>
        <th style={{ padding: "8px 6px", width: 36 }}></th>
       </tr>
      </thead>
      <tbody>
 ...
 return (
  <>
   <div className="card">
    ...
    <div className="row2">
     <div>
      <label>Qty in Bags -- supports arithmetic like 12+49+51</label>
       ...
       <table className="dash" style={{ minWidth: 900 }}>
        <thead>
         <tr>
          ...
          <th>Code</th>
          <th>Mfg Date</th>
          <th style={{ textAlign: "right" }}>Qty Bags</th>
          ...
          <th style={{ textAlign: "right" }}>Rem. Bags</th>
          <th style={{ textAlign: "right" }}>Rem. MT</th>
         </tr>
        </thead>
        <tbody>
         {filtered.map(row => (
