...
const SHEET_TABS: Record<SheetTarget, Record<string, string[]>> = {
  ...
  lab: {
    ...
    // Generated PDF report registers (COA / RM QC / Batch Analysis reports)
    "COA Documents": [
      "ID", "Report No", "Customer", "Product", "Batch No", "Lot No",
      "Qty", "Invoice No", "Vehicle No", "Mfg Date", "PDF URL",
      "Generated By", "Generated At",
    ],
    "RM QC Incoming Reports": [
      "ID", "Supplier", "Batch Number", "Test Date", "Grade", "PDF URL",
      "Generated By", "Generated At", "Factory ID",
    ],
    "Finish Goods Reports": [
      "ID", "Batch Number", "Analysis Date", "PDF URL",
      "Generated By", "Generated At", "Factory ID",
    ],
